...
#ifndef _MotorDriver_PCA9685_8838_H
#define _MotorDriver_PCA9685_8838_H
 ...
 * PWM chip
 */
class MotorDriver_PCA9685_8838 {
 public:
  MotorDriver_PCA9685_8838();
  MotorDriver_PCA9685_8838(const uint8_t addr);
  MotorDriver_PCA9685_8838(const uint8_t addr, TwoWire &i2c);
 ...
 private:
  ...
  uint8_t _M1DIR;        // 电机M1 方向
  uint8_t _M1PWM;        // 电机M1 PWM
  uint8_t _M2DIR;        // 电机M2 方向
  uint8_t _M2PWM;        // 电机M2 PWM
  uint8_t _M3DIR;        // 电机M3 方向
  uint8_t _M3PWM;        // 电机M3 PWM
  uint8_t _M4DIR;        // 电机M4 方向
